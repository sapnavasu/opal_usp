...
<div shelf-sort class="grid half gap-xl">
    <div class="form-group">
        <label for="books">{{ trans('Segment on this Project') }}</label>
        <input type="hidden" id="books-input" name="books"
               value="{{ isset($shelf) ? $shelf->visibleBooks->implode('id', ',') : '' }}">
        <div class="scroll-box" shelf-sort-assigned-books data-instruction="{{ trans('Drag segments here to add them to this project') }}">
    ...
    <div class="form-group">
        <label for="books">{{ trans('Add Segment on this Project') }}</label>
...
<div class="form-group" collapsible id="tags-control">
    <button type="button" class="collapse-title text-primary" collapsible-trigger aria-expanded="false">
        <label for="tag-manager">{{ trans('Project Tags') }}</label>
    </button>
    <div class="collapse-content" collapsible-content>
...
<div class="form-group text-right">
    ...
    <button type="submit" class="button">{{ trans('Save Project') }}</button>
</div>
