...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'shelves'], function() {
        ...
        Route::get('/publiclist', 'BookshelfpublicController@index');
        Route::get('/showdata', 'BookshelfpublicController@index');
        Route::get('/public', 'BookshelfpublicController@showdata');
        Route::get('/private', 'BookshelfpublicController@hiddendata');
