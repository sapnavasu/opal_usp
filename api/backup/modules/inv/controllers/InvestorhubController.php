...
namespace api\modules\inv\controllers;
use Yii;
...
class InvestorhubController extends Controller
{
    ...
    {
        return \common\models\MemberregistrationmstTbl::getInvestorHub($_REQUEST);
    }
    /**
     * @SWG\Get(
     *     path="/inv/investorhub/sectorlist",
     *     tags={"Investor Hub"},
     *     consumes={"application/json"},
     *     produces={"application/json"},
    ...
    public function actionGetcounterlist() {
        return \api\modules\mst\models\CountryMasterQuery::getActiveCountry();
    }
