                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" ><?= $model['companyName'] ?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >Thank you for being a Member of RABT.</span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;line-height: 26px;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >Your Company Name registered with RABT has been changed to <?= $model['companyName_new'] ?> as per the request on the Company Registration Document.</span></span>
                                    </p>
                                    ...
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;line-height: 26px;" ><span style="text-align: center; font-size: 16px;line-height: 26px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;line-height: 26px;" ><strong>Note:</strong> Your RABT <?= $model['suppOrOrg'] ?> Certificate validity will remain the same, but your old certificate can no longer be used for participating in procurement activities.</span></span>
                                    </p>
                                    <!-- <p class="text_lead text_secondary mb_md" style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; margin-top: 0px; margin-bottom: 10px; word-break: break-word; font-size: 16px;" >
                                        <br>
                                    </p> -->

                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 15px; word-break: break-word; text-align: left;" ><span style="color: #333333; font-family: verdana;" ><span style="font-size: 16px;" >For any queries, please email us at <a  href="mailto:support@rabt.om" target="_blank" rel="noopener" style="color: #006cb7;" ><span style="text-decoration: underline;">support@rabt.om</span></a> or call +968 2416 6177.</span>
                                        </span>
                                    </p>
