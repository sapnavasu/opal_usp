                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" ><?= $model['admin']->um_firstname.' '.$model['admin']->um_lastname ?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;line-height:26px;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >You have been changed as a User of your Organisation - <?= $model['compnayname'] ?> on RABT. You now have access only to the features assigned by your Company Admin on the RABT Dashboard. Kindly login to RABT to know more.</span></span>
                                    </p>
