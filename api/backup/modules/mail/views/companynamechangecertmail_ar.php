                    ...
                    <table align="center" border="0" cellspacing="0" width="100%" cellpadding="0" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;margin: 0 auto;padding-bottom:10px;" class="mce-item-table">
                        <tbody>
                            <tr>
                                ...
                                <?php if ($stktype == 6) {echo "(RABT Code ) إعادة إصدار شهادة ربط لسلسلة التوريد- تغيير الاسم";} else {echo "(RABT Code ) إعادة إصدار شهادة ربط للمنشآت الصناعية- تغيير الاسم";}?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >مرحبا <?= (!empty($model['Company_ar']))? $model['Company_ar']: $model['companyName'] ?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >شكرا للانضمام إلى منصة ربط</span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="line-height: 26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >لقد تم تغيير اسم الشركة إلى <?= $model['companyName_new'] ?> بناءا على الطلب المقدم والمستند على وثيقة السجل التجاري للشركة.</span></span>
                                    </p>
                                    <table role="presentation" class="ebutton mce-item-table" align="center" border="0" cellspacing="0" cellpadding="0" style="color: rgb(51, 51, 51); text-size-adjust: 100%; margin: 0px auto;" >
                                        <tbody>
                                            <tr>
                                                <td class="column_cell" style="font-family: Arial, Helvetica, sans-serif;color: #ffffff;font-weight: bold; background-color: #4ca0ab; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; text-size-adjust: 100%; font-size: 16px;padding: 10px 24px; border-radius: 2px; line-height: normal; text-align: right; font-weight: bold;" ><a class="column_cell" href="<?= $model['downloadCertificate'] ?>"  target="_blank" style="cursor:pointer;color: #ffffff;text-decoration: none;font-weight: bold;" rel="noopener"><span class="column_cell">  <?php if ($stktype == 6) {echo "عرض شهادة ربط لسلسة التوريد المحدثة ";} else {echo "عرض شهادة ربط المحدثة";}?></span></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;line-height: 26px;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >
                                    <?php if ($stktype == 6) {echo "ملاحظة: ستبقى صلاحية شهادة ربط لسلسلة التوريد كما هي، ولكن شهادتك القديمة لم تعد صالحة للاستخدام ولا ينبغي استخدامها لأي أغراض تجارية.";} else {echo "ملاحظة: ستبقى صلاحية شهادة ربط للمنشأة كما هي، ولكن شهادتك القديمة لم تعد صالحة للاستخدام ولا ينبغي استخدامها لأي أغراض تجارية.";}?></span></span>
                                    </p>
                                    <!-- <p class="text_lead text_secondary mb_md" style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; margin-top: 0px; margin-bottom: 10px; word-break: break-word; font-size: 16px;" >
                                        <br>
                                    </p> -->
