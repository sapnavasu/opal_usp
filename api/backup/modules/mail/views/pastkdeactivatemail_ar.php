                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_py" style="font-size: 16px;font-family: Arial, Helvetica, sans-serif;min-width:192px;padding: 13px 20px;border-radius: 2px;line-height: normal;text-align: center;font-weight: bold;" >
                                    <h2 style="color: #333333;line-height: 30px;" >ربط: تم إلغاء تنشيط اشتراكك</h2>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right;; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >مرحبا <?= (!empty($model['compnayname_ar']))? $model['compnayname_ar']: $model['compnayname'] ?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="line-height:26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right;; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" ><?php if ($stktype == 6) {echo "نأسف لإبلاغك برفض اشتراكك في شهادة ربط لسلسلة التوريد للأسباب المذكورة أدناه.";} else {echo "نأسف لإبلاغك برفض اشتراكك في شهادة ربط للمنشآت الصناعية للأسباب المذكورة أدناه.";}?></span></span>
                                    </p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="100%" style=" padding:15px;border: 1px solid #4aa1ac;height: 100%;color: #333333; font-family: Arial, Helvetica, sans-serif;" >
                                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 30px; word-break: break-word; text-align: right;" ><span style="text-align: right;; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >تعليقات: <?= $model['deactivate_comments'] ?> </span></span>
                                                    </p>
                                                    <p>
                                                    <br>
                                                    </p>
                                    ...
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right;; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >نطلب منك إعادة التسجيل في منصة ربط إذا كنت ترغب في الاستفادة من المنصة.</span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 15px; word-break: break-word; text-align: right;" ><span style="color: #333333; font-family: verdana;" ><span style="font-size: 16px;" >للمزيد من المعلومات، يرجى التواصل عبر <a  href="mailto:support@rabt.om" target="_blank" rel="noopener" style="color: #006cb7;" ><span style="text-decoration: underline;">support@rabt.om</span></a>  أو الاتصال على 
                                    +968 2416 6177</span>
                                        </span>
                                    </p>
