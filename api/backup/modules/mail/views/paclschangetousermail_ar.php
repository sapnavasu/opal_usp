                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="line-height: 26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >مرحبا <?= (!empty($model['Company_ar']))? $model['Company_ar']: $model['Company_en'] ?> </span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="line-height: 26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >بعد عملية التدقيق قد تبين إنه يجب تحديث تصنيف الشركة إلى <b><?= $model['ClassificationType'] ?></b></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" ><?php if ($stktype == 6) {echo "يرجى إكمال عملية الدفع لمتابعة إجراءات عملية إصدار الشهادة. بعد إتمام الدفع بنجاح، سينعكس تصنيف الشركة المحدث على لوحة التحكم الرئيسية وشهادة ربط لسلسلة التوريد.";} else {echo "يرجى إكمال عملية الدفع لمتابعة إجراءات عم لية إصدار الشهادة. بعد إتمام الدفع بنجاح، سينعكس تصنيف الشركة المحدث على لوحة التحكم الرئيسية وشهادة ربط للمنشآت الصناعية.";}?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" ><strong>مرفق بهذا البريد الإلكتروني نسخة الفاتورة الأولية للرجوع إليها</strong></span></span>
                                    </p>
