                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" ><?= $model['user']->um_firstname.' '.$model['user']->um_lastname; ?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="line-height:26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >You have been assigned as the Primary User (Company Admin) of your Organisation - <?= $model['compnayname'] ?> on RABT. You now have access to Primary User activities on the RABT <?= $model['suppOrOrg'] ?> Dashboard. Kindly login to RABT to know more.</span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: left;line-height:26px;" ><span style="text-align: center; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" > <?= $model['admin']->um_firstname.' '.$model['admin']->um_lastname ?> has changed as User, kindly login and allocate module access for the user from the module Enterprise Admin.</span></span>
                                    </p>
                                    ...
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 15px; word-break: break-word; text-align: left;" ><span style="color: #333333; font-family: verdana;" ><span style="font-size: 16px;" >For queries, please write to <a  href="mailto:support@rabt.om" target="_blank" rel="noopener" style="color: #006cb7;" ><span style="text-decoration: underline;">support@rabt.om</span></a> or call +968 2416 6177.</span>
                                        </span>
                                    </p>
