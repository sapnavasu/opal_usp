                        ...
                        <tbody>
                            <tr>
                                <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " >
                                    <p class="text_lead text_secondary mb_md" style="line-height:26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >مرحبا <?= $model['user']->um_firstname.' '.$model['user']->um_lastname; ?></span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="line-height:26px;margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" >تم تعيينك كمستخدم أساسي (مسؤول الشركة) لمشركتك <?= (!empty($model['compnayname_ar']))? $model['compnayname_ar']: $model['compnayname'] ?>  على منصة ربط.  <?php if ($stktype == 6) {echo "يمكنك الآن الوصول إلى جميع أنشطة المستخدم الأساسي على لوحة التحكم للمورد في المنصة. يرجى تسجيل الدخول إلى ربط لمعرفة المزيد.";} else {echo "يمكنك الآن الوصول إلى جميع أنشطة المستخدم الأساسي على لوحة التحكم للمنشأة في المنصة. يرجى تسجيل الدخول إلى ربط لمعرفة المزيد.";}?> </span></span>
                                    </p>
                                    <p class="text_lead text_secondary mb_md" style="margin-top: 0px; margin-bottom: 20px; word-break: break-word; text-align: right;" ><span style="text-align: right; font-size: 16px;" ><span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" > لقد تم تغيير <?= $model['admin']->um_firstname.' '.$model['admin']->um_lastname ?> إلى مستخدم، يرجى تسجيل الدخول لتخصيص أذونات الوصول إلى الوحدات المعني باستخدامها من خانة  إدارة المؤسسة.</span></span>
                                    </p>
