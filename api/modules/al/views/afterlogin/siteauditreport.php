      ...
      <tr>
         <td style="border-width: 0px;padding: 25px 0 0 25px;">
            <table style="table-layout: fixed; width: 100%;"> 
                <tbody>
                    <tr>
                      <td style="border-width: 0px;font-size: 15px;color: #000000;padding: 12px 0 15px 0;">MoHERI Grading Details</td>
                    </tr>
                    <tr>
                      <td class="shadow-cell">
                          <table style="table-layout: fixed; width: 100%;"> 
                            <tbody>
                              <tr>
                                <td style="width: 22%;border-width: 0px;font-size: 14px;color: #666666;padding: 12px 0;">MoHERI Grading</td>
                                <td style="border-width: 0px;font-size: 14px;color: #262626;padding: 12px 0;"><?= $userdata['omgm_gradename_en']? $userdata['omgm_gradename_en'] : '-'   ?></td>
                              </tr>
                            </tbody>
                        </table>
                      </td>
                          ...
                          <table style="table-layout: fixed; width: 100%;"> 
                            <tbody>
                              <tr>
                                ...
                                <td style="border-width: 0px;font-size: 14px;color: #262626;padding: 12px 0 12px 0;"><?= $appdata['appiit_noofomani']   ?></td>
                              </tr>
                              <tr>
                                <td style="width: 22%;border-width: 0px;font-size: 14px;color: #666666;padding: 0 0 12px 0;">Expatriates</td>
                                <td style="border-width: 0px;font-size: 14px;color: #262626;padding: 0 0 12px 0;"><?= $appdata['appiit_noofexpat']   ?></td>
                              </tr>
                              <tr>
                                <td style="width: 22%;border-width: 0px;font-size: 14px;color: #666666;padding: 0 0 12px 0;">Total</td>
                                <td style="border-width: 0px;font-size: 14px;color: #262626;padding: 0 0 12px 0;"><?= $appdata['totalemployee']   ?></td>
                              </tr>
                              <tr>
                                <td style="width: 22%;border-width: 0px;font-size: 14px;color: #666666;padding: 0 0 12px 0;">Omani Percentage</td>
                                <td style="border-width: 0px;font-size: 14px;color: #262626;padding: 0 0 12px 0;"><?= $appdata['omanpercentage'].'%'   ?></td>
                              </tr>
                            </tbody>
                        </table>
                      </td>
        ...
        <table style="margin-top: 20px">
          <tbody>
            <tr style="background-color: #f4f6f9;">
              <td style="width: 60%;border-width: 0px;font-size: 14px;color: #262626;padding: 15px 0;"></td>
              <td style="width: 20%;border-width: 0px;font-size: 14px;color: #262626;padding: 15px 0;">Grade</td>
              <td style="width: 20%;border-width: 0px;font-size: 14px;color: #262626;padding: 15px 0;">Percentage</td>
            </tr>
            <?php 
            $firstindex = 0;
            foreach($summarydata as $summary){ 
              ...
              ?>
            <tr>
                <td style="width: 60%;border-bottom: 1px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #262626;padding: 15px 0 15px 8px;"><?= $summary['cat_name'] ?></td>
                <td style="width: 20%;border-bottom: 1px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #262626;padding: 15px 0;"><?= $summary['gradename'] ?></td>
                <td style="width: 20%;border-bottom: 1px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #262626;padding: 15px 0;"><?= $summary['percenteage'].'%' ?></td>
            </tr>
            <?php } ?>
            <tr style="background-color: #f4f6f9;">
                <td style="width: 60%;border-bottom: 1px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #262626;padding: 15px 0 15px 8px;">Overall Grading</td>
                <td style="width: 20%;border-bottom: 1px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #262626;padding: 15px 0;"><?= $overall['gm_gradename_en'] ?></td>
                <td style="width: 20%;border-bottom: 1px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #262626;padding: 15px 0;"><?= $overall['percentage'].'%' ?></td>
            </tr>
          </tbody>
        </table>
        <tr>
           <td style="padding-top: 30px;border-width: 0px;font-size: 15px;color: #000000;"><b>Reasons for Grading</b></td>
        </tr>
        <tr>
    ...
    <tbody>
      ...
      <td style="border-width: 0px;">
             <table>
                 <tbody>
                     <tr>
                        <td style="width: 30%; border-width: 0px;font-size: 17px;color: #0c4b9a;padding: 0;">3. OPAL STAR Desktop Review</td>
                     </tr>
                 </tbody>
             </table>
         </td>
            ...
            <table>
              <tbody>
                <tr style="background-color: #ffffff;">
                  <td style="width: 70%;border-bottom: 2px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #666666;padding: 30px 0 15px 0;">Validated by: <span style="color: #262626;font-size: 14px;"><?= $desktop['oum_firstname'] ?></span></td>
                  <td style="width: 15%;border-bottom: 2px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #666666;padding: 30px 0 15px 0;">Date: <span style="color: #262626;font-size: 14px;border-right: 2px solid #cccccc;padding: 0px 15px"><?= $desktop['aarlappdecon'] ?> &nbsp;&nbsp;</span></td>
      ...
      <tr>
         <td style="border-width: 0px;">
             <table>
                 <tbody>
                     <tr>
                       <td style="width: 33%;border-width: 0px;font-size: 17px;color: #0c4b9a;padding: 0;">4. OPAL STAR Provider Site Audit</td>
                     </tr>
                 </tbody>
             </table>
         </td>
                ...
                <tbody>
                   <?php if(empty($alldata['asaqm_comments'])){ ?>
                      <tr style="background-color: #ffffff;">
                        ...
                        <td style="border-bottom: 0px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #666666;padding: 30px 0 15px 0 18px;">Status: <span style="color: #262626;font-size: 14px;"><?= $answer ?></span></td>
                      </tr>
                    <?php }else{ ?>
                      <tr style="background-color: #ffffff;">
                        ...
                        <td style="border-bottom: 2px solid #f4f6f9;border-top: 0px;border-left: 0px;border-right: 0px;font-size: 14px;color: #666666;padding: 30px 0 15px 0 18px;">Status: <span style="color: #262626;font-size: 14px;"><?= $answer ?></span></td>
                      </tr>
                   <?php } ?>
                </tbody>
              </table>
            ...
            <td style="border-width: 0px;">
                <table style= "margin-left: 20px;"> 
                     ...
                     <tr>
                        ...
                        <tr>
                            <td style="padding: 10px 0 0px 0px;line-height: 1.4;border-width: 0px;font-size: 14px;color: #262626;">I declare that at all times the OPAL STAR provider procedure was followed and that decisions made about the standard of documentation provided was against the grading guidelines outlined in document OPAL-STD-QA-101.</td>
                        </tr>
                     </tbody>
                </table>
            </td>
              ...
              <tr class="shadow-cell">
                <td style="border-width: 0px;">
                  <table >
                      <tbody>
                        <tr style="background-color: #ffffff;">
                          <td valign="top" style="width: 5px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Name: </td>
                          <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $siteauditor['oum_firstname']? $siteauditor['oum_firstname']:'Nil' ?> <br><span style="color:#262626;font-size: 12px;">(Quality Auditor)</span></td>
                        </tr>
                      </tbody>
                    </table> 
                </td>
                  <td style="border-width: 0px;width: 25%;">
                    <table >
                        <tbody>
                          <tr style="background-color: #ffffff;">
                            <td style="width: 5px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Date: </td>
                            <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $siteauditor['aarlappdecon']?$siteauditor['aarlappdecon']:'Nil' ?></td>
                          </tr>
                        </tbody>
                      </table> 
                  </td>
              ...
              <tr class="shadow-cell">
                <td style="border-width: 0px;">
                  <table >
                      <tbody>
                        <tr style="background-color: #ffffff;">
                          <td valign="top" style="width: 105px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Reviewed by: </td>
                          <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $qualitimanager['oum_firstname']? $qualitimanager['oum_firstname']:'Nil' ?> <br><span style="color:#262626;font-size: 12px;">(Quality Manager)</span></td>
                        </tr>
                      </tbody>
                    </table> 
                </td>
                  <td style="border-width: 0px;width: 25%;">
                    <table >
                        <tbody>
                          <tr style="background-color: #ffffff;">
                            <td style="width: 7px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Date: </td>
                            <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $qualitimanager['aarlappdecon']?$qualitimanager['aarlappdecon']:'Nil' ?></td>
                          </tr>
                        </tbody>
                      </table> 
                  </td>
              ...
              <tr class="shadow-cell">
                <td style="border-width: 0px;">
                  <table >
                      <tbody>
                        <tr style="background-color: #ffffff;">
                          <td valign="top" style="width: 105px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Validated by: </td>
                          <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $authoriy['oum_firstname']? $authoriy['oum_firstname']:'Nil' ?> <br><span style="color:#262626;font-size: 12px;">(GM. Quality & Accreditation)</span></td>
                        </tr>
                      </tbody>
                    </table> 
                </td>
                  <td style="border-width: 0px;width: 25%;">
                    <table >
                        <tbody>
                          <tr style="background-color: #ffffff;">
                            <td valign="top" style="width: 7px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Date: </td>
                            <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $authoriy['aarlappdecon']?$authoriy['aarlappdecon']:'Nil' ?></td>
                          </tr>
                        </tbody>
                      </table> 
                  </td>
              ...
              <tr class="shadow-cell">
                <td style="border-width: 0px;">
                  <table >
                      <tbody>
                        <tr style="background-color: #ffffff;">
                          <td valign="top" style="width: 105px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Approved by: </td>
                          <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $ceo['oum_firstname']? $ceo['oum_firstname']:'Nil' ?> <br><span style="color:#262626;font-size: 12px;">(OPAL CEO)</span></td>
                        </tr>
                      </tbody>
                    </table> 
                </td>
                  <td style="border-width: 0px;width: 25%;">
                    <table >
                        <tbody>
                          <tr style="background-color: #ffffff;">
                            <td valign="top" style="width: 7px;padding: 20px 0 0 20px;border-width: 0px;font-size: 14px;color: #666666;">Date: </td>
                            <td style="padding: 20px 0 0 10px;border-width: 0px;font-size: 14px;color: #262626;"><?= $ceo['aarlappdecon']?$ceo['aarlappdecon']:'Nil' ?></td>
                          </tr>
                        </tbody>
                      </table> 
                  </td>
