        ...
        <tr>
          ...
          <p class="text_lead text_secondary mb_md"
                ...
                <p class="text_lead text_secondary mb_md"
                    ...
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;"
                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                            style="font-size: 16px;" data-mce-style="font-size: 16px;">This is to inform you, that your Training Evaluation Centre Certificate on OPAL USP has been Re-activated. </span></span>
                </p>
        ...
        <tr>
            ...
            <td class="column_cell md_px" colspan="3"
                ...
                <p class="text_lead text_secondary mb_md"
                        ...
                        <tr>
                            ...
                            <td  width="60%" valign="top" 
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    ...
                                    <strong><?= $certiData['companyName'] ?></strong>
                                </p>
                            </td>
                        </tr>
                         <tr>
                            ...
                            <td  width="60%" valign="top" 
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <strong><?= $certiData['tpname'] ?></strong>
                                </p>
                            </td>
                        </tr>
                           ...
                           <tr>
                            ...
                            <td  width="60%" valign="top" 
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <strong><?php if($certiData['officetype']=='1'){
                    ...
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;"
                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                            style="font-size: 16px;" data-mce-style="font-size: 16px;">Now that your Training Evaluation Centre’s Certificate has been re-activated, you have regained you access to create Batch and conduct training on OPAL USP. 
                        </span></span>
                </p>
