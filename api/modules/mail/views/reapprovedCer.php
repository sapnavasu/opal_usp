<table class="content_column md_mx mce-item-table" align="center" border="0" cellspacing="0" cellpadding="0"
    ...
    <tbody>
         ...
         <tr>
            <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " data-mce-style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding:0px;">
                <p class="text_lead text_secondary mb_md" style=" word-break: break-word; line-height: 26px; margin-left: 0px; margin-right: 0px; text-size-adjust: 100%; text-align: left;padding:0px 0px 15px 0px;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;  word-break: break-word; font-size: 16px; line-height: 26px; margin-left: 0px; margin-right: 0px; text-size-adjust: 100%; text-align: left;">
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span style="font-size: 16px;" data-mce-style="font-size: 16px;"> Congratulations! You have successfully renewed your Training Evaluation Centre Certificate on the OPAL USP. Please find updated eCertificate details below.  
                        </span></span>
                </p>
            </td>
        </tr>
                          ...
                          <?php if($certiData['branchName']){ ?>
                           ...
                           <tr>
                            <td nowrap width="40%" valign="top"
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">Company eCertificate</p>
                            </td>
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:0;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%" valign="top"
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
...
$link = $baseUrl . $certiData['certificationpath']; ?>
                ...
                <p class="text_lead text_secondary mb_md"
                    ...
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;line-height:26px;"
                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                            style="font-size: 16px;" data-mce-style="font-size: 16px;">You can now login and apply for Standard Course and/or create Customised Courses based on the details provided in your Training Evaluation Centre Certification Form. Once your Courses are approved, you can create and manage batch, learners, learner cards and much more. </span></span>
                </p>
            </td>
        </tr>
                    ...
                    <td class="column_cell"
                        ...
                        <a class="column_cell" data-mce-href="<?= $navlink ?>" href="<?= $navlink ?>" target="_blank"
                            ...
                            data-mce-style="color: #ffffff;text-decoration: none;font-weight: bold;cursor:pointer;"><span
                                class="column_cell">Login</span></a>
                    </td>
                </tr>
            </tbody>
        </table>
