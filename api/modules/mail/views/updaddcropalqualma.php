        ...
        <tr>
            <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " data-mce-style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding:0px;">
                <table width="100%" role="presentation" class="ebutton mce-item-table" align="left" border="0" cellspacing="0" cellpadding="0" style="width:100%; text-size-adjust: 100%;" data-mce-style="width:100%;-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                    <tbody>
                              <tr>
                            <td class="column_cell md_px"  valign="top" colspan="3"
                                ...
                                <p class="text_lead text_secondary mb_md"
                                    ...
                                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;line-height:26px;"
                                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                                            style="font-size: 16px;" data-mce-style="font-size: 16px;"><b>Centre and Course Details  </b>
                                        </span></span>
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td nowrap width="40%"  valign="top"
                                style="text-align: left;width:30%;font-size: 16px;font-family: Arial; padding-left:10px"
                            ...
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%"  valign="top"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    ...
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['appno'] ?>
                                </p>
                            </td>
                        </tr>
                            <tr>
                            <td nowrap width="40%"  valign="top"
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">Company Name</p>
                            </td>
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%"  valign="top"
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['companyName'] ?>
                                </p>
                            </td>
                            </tr>
                                <tr>
                            <td nowrap width="40%"  valign="top"
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">Training Provider Name</p>
                            </td>
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%"  valign="top"
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
                            ...
                            <td  width="60%"  valign="top"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?php if($courseData['officeType']=='1'){
                            ...
                            <td  width="60%"  valign="top"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['branchname'] ?>
                                </p>
                            </td>
                            ...
                            <td  width="60%"  valign="top"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['coursetitle'] ?>
                                </p>
                            </td>
                            </tr>
                             <tr>                            
                            ...
                            <td  width="60%"  valign="top"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['coursecategory'] ?>
                                </p>
                            </td>
                            </tr>
                               <tr>                            
                            ...
                            <td  width="60%"  valign="top"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['requestedfor'] ?>
                                </p>
                            </td>
                            </tr>
                            ...
                            <td nowrap width="40%"  valign="top"
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">Site Auditor</p>
                            </td>
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%"  valign="top"
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <td width="2%" valign="top" style="padding-right: 4px;padding-top:10px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td><?= $courseData['siteAuditName'] ?>
                                </p>
                            </td>
                            </tr>
                    </tbody>
