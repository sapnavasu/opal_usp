        ...
        <tr>
          ...
          <p class="text_lead text_secondary mb_md"
                ...
                <p class="text_lead text_secondary mb_md"
                    ...
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;"
                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                            style="font-size: 16px;" data-mce-style="font-size: 16px;">This is to inform you that as of <suspended date>, your Training Evaluation Centre Certificate on OPAL USP has been suspended</span></span>
                </p>
                ...
                <table width="100%" role="presentation" class="ebutton mce-item-table" align="left" border="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%" valign="top" style="padding-right: 4px;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%"
