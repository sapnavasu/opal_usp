    ...
    <tbody>
          <tr>
            <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " data-mce-style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding:0px;">
                <p class="text_lead text_secondary mb_md" style="margin-bottom: 0px; word-break: break-word; line-height: 26px; margin-left: 0px; margin-right: 0px; text-size-adjust: 100%; text-align: left;padding:0px 0px 15px 0px;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif; margin-bottom: 25px; word-break: break-word; font-size: 16px; line-height: 26px; margin-left: 0px; margin-right: 0px; text-size-adjust: 100%; text-align: left;">
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span style="font-size: 16px;" data-mce-style="font-size: 16px;"><?= $accessorData['newaccfocalname'] ?>, 
                        </span></span>
                </p>
            </td>
        </tr>
        <tr>
            <td class="column_cell md_px" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px " data-mce-style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding:0px;">
                <p class="text_lead text_secondary mb_md" style="margin-bottom: 0px; word-break: break-word; line-height: 26px; margin-left: 0px; margin-right: 0px; text-size-adjust: 100%; text-align: left;padding:0px 0px 15px 0px;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif; margin-bottom: 25px; word-break: break-word; font-size: 16px; line-height: 26px; margin-left: 0px; margin-right: 0px; text-size-adjust: 100%; text-align: left;">
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span style="font-size: 16px;" data-mce-style="font-size: 16px;"> This is to inform you that your Centre’s staff has been assigned to do Assessment for the following Batch.   
                        </span></span>
                </p>
            </td>
        </tr>
                    ...
                    <tbody>
                     ...
                     <tr>
                            <td nowrap width="40%" valign="top" 
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px"><strong>Assessor</strong></p>
                            </td>
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:0;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%" valign="top" 
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
                         ...
                         <tr>
                            ...
                            <td  width="60%" valign="top" 
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                   <?= $accessorData['accessmentdate'] ?> (  <?= $accessorData['accesstarttime'] ?>  - <?= $accessorData['accesendtime']?>)
                                </p>
                            </td>
                        </tr>
                         <tr>
                            <td nowrap width="40%" valign="top" 
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px"><strong>IV/QA Staff</strong></p>
                            </td>
                            <td width="2%" valign="top" style="padding-right: 4px;padding-top:0;text-align: left;font-size: 16px;font-family: Arial;" data-mce-style="padding-top:15px;text-align: left;font-size: 16px;font-family: Arial;"><strong>:</strong></td>
                            <td  width="60%" valign="top" 
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
...
<tr>
    <td class="column_cell md_px" style="margin-left: 15px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding: 0px 15px " data-mce-style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;padding:0px 15px;margin-left: 15px;">
        <p class="text_lead text_secondary mb_md" style="margin-top: -5px; margin-left: 55px;margin-bottom: 20px; word-break: break-word; text-align: left;line-height: 26px" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif; margin-top: 0px; margin-bottom: 20px; word-break: break-word; font-size: 16px; text-align: left;line-height: 26px">
            <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;line-height:26px;" data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span style="font-size: 16px;" data-mce-style="font-size: 16px;">Note: Provision to Change Assessor will be available against a Batch, in case the Assigned Assessor is not available on the Assessment Date & Time.</span></span>
        </p>
    </td>
</tr>
