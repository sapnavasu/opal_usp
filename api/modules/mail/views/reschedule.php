        ...
        <tr>
            <td class="column_cell md_px"
                ...
                <p class="text_lead text_secondary mb_md"
                    ...
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;"
                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                            style="font-size: 16px;" data-mce-style="font-size: 16px;">  <?= $certiData['companyName']?> </span></span>
                </p>
                ...
                <p class="text_lead text_secondary mb_md"
                    ...
                    <span style="color: #333333; font-family: Arial, Helvetica, sans-serif;"
                        data-mce-style="color: #333333; font-family: Arial, Helvetica, sans-serif;"><span
                            style="font-size: 16px;" data-mce-style="font-size: 16px;">The OPAL team has rescheduled the site audit date for your Training Evaluation Centre Certification.</span></span>
                </p>
                        ...
                        <tr>
                            ...
                            <td  width="60%"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    ...
                                    <strong>:&nbsp;<?= $certiData['appRefNo'] ?></strong>
                                </p>
                            </td>
                        </tr>
                          ...
                          <?php if($certiData['branchName']){ ?>
                            ...
                            <td  width="60%"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <strong>:&nbsp;<?= $certiData['branchName'] ?></strong>
                                </p>
                            </td>
                            </tr>
                            <?php } ?>
                         ...
                         <tr>
                          ...
                          <tr>
                            <td nowrap width="40%"
                                ...
                                data-mce-style="text-align: left;width:30%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px; margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">Rescheduled Site Audit Date</p>
                            </td>
                            <td  width="60%"
                                style="text-align: left;width:70%;font-size: 16px;font-family: Arial;"
                                data-mce-style="text-align: left;width:70%;font-size: 16px;font-family: Arial;">
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <strong>:&nbsp;<?= $certiData['siteAuditDt'] ?></strong>
                                </p>
                            </td>
                        </tr>
                          <tr>
                            ...
                            <td  width="60%"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 10px;"
                                    data-mce-style="margin-top: 0px;margin-bottom: 10px">
                                    <strong>:&nbsp;<?= $certiData['siteAuditName'] ?></strong>
                                </p>
                            </td>
                        </tr>
