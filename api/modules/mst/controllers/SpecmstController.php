...
use api\modules\mst\models\SpecificationmstTbl;

class SpecmstController extends MasterController
{
    public $modelClass = 'api\modules\mst\models\SpecificationmstTbl';
    ...
    public function actionIndex(){
        ...
        $query = SpecificationmstTbl::find();
        ...
        $query->select(['specificationmst_tbl.*',
            'if(specificationmst_tbl.SpM_Status = "A", "primary","warn") as `color`', 'if(specificationmst_tbl.SpM_SpecCategory = "P", "Product","Service") as `SpM_SpecCategory`']);
        $query->asArray();
    ...
    public function actionView($id){
        $industry = SpecificationmstTbl::find()->where([
    ...
    public function actionSearch($id){
        $industry = SpecificationmstTbl::find()->active()->where([
            'SpecificationMst_Pk'    =>  $id
        ])->one();
        if($industry){
            return $industry;
    ...
    public function actionNewspec(){
        ...
        $model->load($params, '');
        $model->SpM_CreatedOn = date('Y-m-d H:i:s');
        $userpk = \yii\db\ActiveRecord::getTokenData('UserMst_Pk',true);
        $model->SpM_CreatedBy = $userpk;
        $model->load($params, '');
    ...
    public function actionUpdate($id) {
        ...
        $request_body	=	file_get_contents('php://input');
        $data =	json_decode($request_body, true);
        $model = SpecificationmstTbl::find()->where([
            'SpecificationMst_Pk'    =>  $id
        ])->one();
        if($data['sepcmaster'])
        {
