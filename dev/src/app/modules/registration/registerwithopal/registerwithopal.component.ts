import { Component, OnInit, ViewChild,ElementRef, EventEmitter, ChangeDetectorRef, OnDestroy, ɵbypassSanitizationTrustStyle, ViewEncapsulation, Output } from '@angular/core';
...
@Component({
  selector: 'app-registerwithopal',
  templateUrl: './registerwithopal.component.html',
  styleUrls: ['./registerwithopal.component.scss'],
  animations: [SlideInOutAnimation],
  encapsulation: ViewEncapsulation.None,
})
export class registerwithopalComponent implements OnInit, OnDestroy,DirtyCheckGuard {
  scrollTop: number;
  ...
  DirtyControl(control) {
    this.isDirty = control;
   }
