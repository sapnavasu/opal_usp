...
@Component({
  selector: 'app-sitepractical',
  templateUrl: './sitepractical.component.html',
  styleUrls: ['./sitepractical.component.scss'],
...
export class SitepracticalComponent implements OnInit {
  ...
  staffrecordcolumn = [
    ...
    { staffcolumn: "practical_status", srchFilt: "row-practical", label: "Practical Assessment Status", DataVisible: true, disoperate: false },
