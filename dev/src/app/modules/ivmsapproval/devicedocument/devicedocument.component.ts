...
@Component({
  selector: 'app-devicedocument',
  templateUrl: './devicedocument.component.html',
  styleUrls: ['./devicedocument.component.scss'],
...
export class DevicedocumentComponent implements OnInit {
  ...
  fetchDocumentData() {
    ...
    var gridsearchvalue = {};
    gridsearchvalue = { appdst_documentdtlsmst_fk: this.appdst_documentdtlsmst_fk.value, appdst_status: this.appdst_status.value, appdst_createdon: this.appdst_createdon.value, appdst_updatedon: this.appdst_updatedon.value };
