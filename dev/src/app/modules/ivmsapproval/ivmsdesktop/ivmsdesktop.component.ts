...
@Component({
  selector: 'app-ivmsdesktop',
  templateUrl: './ivmsdesktop.component.html',
  styleUrls: ['./ivmsdesktop.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class IvmsdesktopComponent implements OnInit {
 ...
 checkprojectpk() {
  if(this.projectpk == 'IVMS') {
    this.tab1 = this.i18n('desktop.compdeti');
