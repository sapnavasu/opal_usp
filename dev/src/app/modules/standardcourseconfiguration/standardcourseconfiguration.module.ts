...
import { StandardcourseconfigurationRoutingModule } from './standardcourseconfiguration-routing.module';
...
export function createTranslateLoader(http: HttpClient) {
  return new TranslateHttpLoader(http, './assets/i18n/standardcourseconfiguration/', '.json');
}

@NgModule({
  declarations: [SccgridlistComponent, ViewcoursegridlistComponent, AddstandardcourseComponent, AddsubcategoryComponent, AddconfiguredocumentComponent],
  imports: [
    CommonModule,
    StandardcourseconfigurationRoutingModule,
    MatTabsModule,
    FlexLayoutModule,
...
export class StandardcourseconfigurationModule { }
