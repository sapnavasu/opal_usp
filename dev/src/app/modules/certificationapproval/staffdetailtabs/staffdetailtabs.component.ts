...
const staffrecord_data: Staffrecorddata[] = [
  { civilnumber: '10610796',staffname:"Ahmed Bin Al Rahman",emailid:"ahmedbinal@gmail.com",age:"32",gender:"Female",contracttype:"Temporary",mainrole:"Trainer",status:"A",addedon:"10-10-2021",lastupdated:"10-10-2021"},
  { civilnumber: '10610797',staffname:"Sameer Mohammed",emailid:"sameermohammed@gmail.com",age:"35",gender:"Male",contracttype:"Permanent",mainrole:"Tutor",status:"D",addedon:"24-01-2023",lastupdated:"06-06-2021"},
  { civilnumber: '10610798',staffname:"Ahmed Bin Al Rahman",emailid:"ahmedbinal@gmail.com",age:"38",gender:"Female",contracttype:"Temporary",mainrole:"Trainer",status:"A",addedon:"10-10-2021",lastupdated:"10-10-2021"},
  { civilnumber: '10610799',staffname:"Muhammad Imran Rafiq",emailid:"Muhammad Imran Rafiq",age:"32",gender:"Male",contracttype:"Permanent",mainrole:"Tutor",status:"N",addedon:"10-10-2021",lastupdated:"06-06-2021"},
  { civilnumber: '10610800',staffname:"Ahmed Bin Al Rahman",emailid:"Muhammad Imran Rafiq",age:"31",gender:"Female",contracttype:"Temporary",mainrole:"Trainer",status:"U",addedon:"10-10-2021",lastupdated:"10-10-2021"}
...
@Component({
  selector: 'app-staffdetailtabs',
  templateUrl: './staffdetailtabs.component.html',
  styleUrls: ['./staffdetailtabs.component.scss'],
...
export class StaffdetailtabsComponent implements OnInit {
  ...
  sir_gender: any;
  natioanl_filt: any;
  appsit_updatedon: any;
  appsit_createdon: any;
  sir_dob: any;
  inspect_ion: any;
  appsit_contracttype: any;
  appsit_mainrole: any;
  appsit_apprasvehinspcattmp_fk:any;
  ocym_countryname_en:any;
  appsit_roleforcourse:any;
  compcardfilt: any;
  appsit_status: any;
    // staff
...
disableSubmitButton: boolean;
  ...
  @ViewChild("paginator") paginator: MatPaginator;
   // table stafff start
   staffrecordcolumn = [
    { staffcolumn: "checkbox", srchFilt: "row-first", label: "CheckBox", DataVisible: true, disoperate: true },
    ...
    { staffcolumn: "appsit_contracttype", srchFilt: "row-seven", label: "staff.conttype", DataVisible: true, disoperate: false },
    { staffcolumn: "appsit_mainrole", srchFilt: "row-eight", label: "staff.mainrole", DataVisible: false, disoperate: false },
  ...
  // table staff end
  //staffrecorddata = new MatTableDataSource<Staffrecorddata>(staffrecord_data);
  ...
  ngOnInit(): void {
    ...
    if(this.projectpk == 1)  {
      ...
      this.staffrecordcolumn = [
        ...
        { staffcolumn: "sir_dob", srchFilt: "row-five", label: "staff.age", DataVisible: false, disoperate: false },
        { staffcolumn: "sir_gender", srchFilt: "row-six", label: "staff.gend", DataVisible: true, disoperate: true },
        { staffcolumn: "appsit_contracttype", srchFilt: "row-seven", label: "staff.conttype", DataVisible: false, disoperate: false },
        { staffcolumn: "ocym_countryname_en", srchFilt: "row-national", label: "Nationality", DataVisible: false, disoperate: false },
        { staffcolumn: "appsit_roleforcourse", srchFilt: "row-newone", label: "Roles", DataVisible: false, disoperate: false },
        { staffcolumn: "appsit_apprasvehinspcattmp_fk", srchFilt: "row-inspection", label: "Inspection Categories", DataVisible: true, disoperate: false },
        { staffcolumn: "appsit_status",srchFilt: "row-nine", label: "staff.Stat", DataVisible: true,disoperate: false },
        { staffcolumn: "comp_card", srchFilt: "row-comp", label: "Competency Card", DataVisible: false, disoperate: true },
        { staffcolumn: "appsit_createdon", srchFilt: "row-ten", label: "staff.addeon", DataVisible: true, disoperate: false },
        { staffcolumn: "appsit_updatedon", srchFilt: "row-eleven", label: "staff.lastupdaon", DataVisible: false, disoperate: true },
        { staffcolumn: "action", srchFilt: "row-twelve", label: "staff.acti", DataVisible: true, disoperate: true },
      ];
    }
  }
