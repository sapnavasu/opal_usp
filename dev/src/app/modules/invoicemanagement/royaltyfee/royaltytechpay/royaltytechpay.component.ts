...
// ];
@Component({
  selector: 'app-royaltytechpay',
  templateUrl: './royaltytechpay.component.html',
  styleUrls: ['./royaltytechpay.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class RoyaltytechpayComponent implements OnInit {
  ...
  // View Royal Tech
  viewRoyalTech() {
    this.service.viewRoyaltyTech(atob(this.royaltyTechId)).subscribe((data: any) => {
  ...
  getRoyalVehical(limit: any, index: any, searchkey: any) {
    ...
    this.service.vehicleDetails(atob(this.royaltyTechId), limit, index, searchkey, this.filterDataPage).subscribe((data: any) => {
