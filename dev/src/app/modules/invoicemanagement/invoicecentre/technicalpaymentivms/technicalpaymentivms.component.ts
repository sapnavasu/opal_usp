...
@Component({
  selector: 'app-technicalpaymentivms',
  templateUrl: './technicalpaymentivms.component.html',
  styleUrls: ['./technicalpaymentivms.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class TechnicalpaymentivmsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      if(this.security.decrypt(params['id'])){
        ...
        this.technicalService.viewtechnicalivms(this.security.decrypt(params['id'])).subscribe(res => {
