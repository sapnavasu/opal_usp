...
//   { invoiceno: 'INV-999-CRI-2022-32', compannyname: 'Al Khelijan Techical service', centrename: 'KHDH', officetype: 'Main Branch', branchname: 'Direct Contract', opalmember: 'cyber Security', projectname: 'Roadworthiness Assurance', Feetype: 'Centre Recognisation(Initial)', noofstaff: '3', invoiceamount: '105.000', paymentstatus: 'R', paymenttype: 'O', invoicedate: '23-04-2024', invoiceage: '20 Days', paymentdate: 20 - 1 - 2023 },
//   { invoiceno: 'INV-999-CRI-2022-32', compannyname: 'Al Khelijan Techical service', centrename: 'KHDH', officetype: 'Main Branch', branchname: 'Direct Contract', opalmember: 'cyber Security', projectname: 'Roadworthiness Assurance', Feetype: 'Centre Recognisation(Initial)', noofstaff: '4', invoiceamount: '105.000', paymentstatus: 'P', paymenttype: 'CH', invoicedate: '23-04-2024', invoiceage: '20 Days', paymentdate: 20 - 1 - 2023 },
...
export class TechnicalcentreComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.technicalService.gettechnicalcertidtls(data).subscribe((res) => {
      this.loaderforpage = false;
  ...
  // view button
  view(id: number) {
    this.route.navigate(['/invoicemanagement/technicalpayment'], { queryParams: { id: this.security.encrypt(id) } });
  }
  ...
  announceSortChange(sortState: Sort) {
    ...
    this.getData(null, this.paginator.pageIndex, this.paginator.pageSize, this.filterdata, this.filterDataPage);
  }
  ...
  exportData() {
    ...
    this.technicalService.exportData(
