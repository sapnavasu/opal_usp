...
export class AddComponent implements OnInit {
  ...
  dir: string = 'ltr';
  get form()  { return this.roadtype.controls; }
  i18n(key) {
  ...
  submit(data){
    ...
    if(this.pagetype == 'add'){
      this.service.addreference(data).subscribe(res=>{
        ...
        console.log(data);
        this.toastr.success(this.i18n('Road Type added Successfully'), ''), {
          timeOut: 2000,
          closeButton: false,
        };
        this.router.navigate(['/configuration/masterdataconfiguration/roadtype']);
      },error=>{
        swal({
      ...
      this.service.editreference(data).subscribe(res=>{
        this.toastr.success(this.i18n('Road Type updated Successfully'), ''), {
          timeOut: 2000,
          closeButton: false,
        };
        this.router.navigate(['/configuration/masterdataconfiguration/roadtype']);
