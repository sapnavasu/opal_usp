...
export class AddComponent implements OnInit {
  ...
  vehiclemanufacturer : FormGroup;
  languagelist = [{ "id": "1", "languageName": "English", "languagecode": "en", "CountryMst_Pk": "136", "dir": "ltr" },
  { "id": "2", "languageName": "Arabic", "languagecode": "ar", "CountryMst_Pk": "31", "dir": "rtl" }];
  dir: string = 'ltr';
  get form()  { return this.vehiclemanufacturer.controls; }
  i18n(key) {
  ...
  ngOnInit(): void {
    ...
    if(this.id){
      ...
      this.pagetype = 'add';
      this.vehiclemanufacturer = this.fb.group({
  ...
  submit(data){
    ...
    if(this.pagetype == 'add'){
      this.service.addreference(data).subscribe(res=>{
        ...
        this.disableSubmitButton = false;
        console.log(data);
        this.toastr.success(this.i18n('Vehicle Manufacturer added Successfully'), ''), {
          timeOut: 2000,
          closeButton: false,
        };
        this.router.navigate(['/configuration/masterdataconfiguration/vehiclemanufacturers']);
      },error=>{
        this.disableSubmitButton = false;
        swal({
      ...
      this.service.editreference(data).subscribe(res=>{
        this.disableSubmitButton = false;
        this.toastr.success(this.i18n('Vehicle Manufacturer updated Successfully'), ''), {
          timeOut: 2000,
          closeButton: false,
        };
        this.router.navigate(['/configuration/masterdataconfiguration/vehiclemanufacturers']);
