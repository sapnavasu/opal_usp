...
export class EditComponent implements OnInit {
  ...
  assessmentin : FormGroup;
  languagelist = [{ "id": "1", "languageName": "English", "languagecode": "en", "CountryMst_Pk": "136", "dir": "ltr" },
  { "id": "2", "languageName": "Arabic", "languagecode": "ar", "CountryMst_Pk": "31", "dir": "rtl" }];
  dir: string = 'ltr';
  get form()  { return this.assessmentin.controls; }
  i18n(key) {
  ...
  getrefer(id){
    ...
    this.service.getreference(id).subscribe(res=>{
      let data = res.data;
      this.assessmentin = this.fb.group({
  ...
  submit(data){
    ...
    this.service.editreference(data).subscribe(res=>{
      this.toastr.success(this.i18n('AssessmentIn updated Successfully'), ''), {
        timeOut: 2000,
        closeButton: false,
      };
      this.router.navigate(['/configuration/masterdataconfiguration/assessmentin']);
    },error=>{
      swal({
