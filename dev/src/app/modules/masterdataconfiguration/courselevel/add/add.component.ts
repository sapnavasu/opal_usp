...
export class AddComponent implements OnInit {
  ...
  dir: string = 'ltr';
  get form()  { return this.courselevel.controls; }
  i18n(key) {
  ...
  submit(data){
    ...
    if(this.pagetype == 'add'){
      this.service.addreference(data).subscribe(res=>{
        ...
        console.log(data);
        this.toastr.success(this.i18n('Course Level added Successfully'), ''), {
          timeOut: 2000,
          closeButton: false,
        };
        this.router.navigate(['/configuration/masterdataconfiguration/courselevel']);
      },error=>{
        swal({
      ...
      this.service.editreference(data).subscribe(res=>{
        this.toastr.success(this.i18n('Course Level updated Successfully'), ''), {
          timeOut: 2000,
          closeButton: false,
        };
        this.router.navigate(['/configuration/masterdataconfiguration/courselevel']);
