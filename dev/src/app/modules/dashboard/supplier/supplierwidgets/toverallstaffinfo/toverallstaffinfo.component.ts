...
@Component({
  selector: 'app-toverallstaffinfo',
  templateUrl: './toverallstaffinfo.component.html',
  styleUrls: ['./toverallstaffinfo.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ToverallstaffinfoComponent implements OnInit {
