...
@Component({
  selector: 'app-profileviewdetails',
  templateUrl: './profileviewdetails.component.html',
  styleUrls: ['./profileviewdetails.component.scss']
})
export class ProfileviewdetailsComponent implements OnInit {
  masterdata: any = [];
  certificate: any = [];
  addressists: any = [];
  @Input() viewserviceid: number;
  ...
  ngOnInit() {
    ...
    this.profileservice.getUserprofMaster(this.viewserviceid).subscribe(returndata => {
      this.masterdata = returndata.data['mstdata'];
      this.certificate = returndata.data['certificatedata'];
