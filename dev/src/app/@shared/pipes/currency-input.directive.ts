...
export class CurrencyInputDirective implements OnInit {
  ...
  ngOnInit() {
    this.el.value = this.currencyPipe.transform(this.el.value,this.currencyType,'');
  }
  ...
  onBlur(value) {
    ...
    this.el.value = this.currencyPipe.transform(value, this.currencyType,'');
  }
