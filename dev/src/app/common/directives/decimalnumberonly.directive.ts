...
export class DecimalnumberonlyDirective {
  ...
  onKeyDown(e: KeyboardEvent) {
    ...
    if (
      ...
      || ( e.keyCode >= 96 && e.keyCode <= 105 ) || (!e.shiftKey && e.keyCode == 222)
      || (!e.shiftKey && e.keyCode == 189) || (!e.shiftKey && e.keyCode == 109)
      || (e.shiftKey && (e.keyCode == 57 || e.keyCode == 48 || e.keyCode == 55 || e.keyCode == 190))
      ) {
      return true;
    }else{
      e.preventDefault();
